...
if(Request::get('state')=='qqreg'){
	...
	$keysArr = array(
			...
			"client_id" => '100543439',
			"redirect_uri" => urlencode('http://www.weixinguanjia.cn'),
...
if(strpos(strtolower($_SERVER ['HTTP_HOST']),'houtai.weixinguanjia.cn') !== false || strpos(strtolower($_SERVER ['HTTP_HOST']), 'wx.dxcx.com') !== false){
